...
describe('Service: dashboardApi', function () {
  ...
  it('should have a createDashboard method', function(done) {
    ...
    dashboardApi.createDashboard(dashboard).then(function(response) {
  ...
  it('should have a createDashboard method with desktop layout', function(done) {
    var dashboard = {};
  ...
  xit('should have a updateCurrentDashboardName method - return false on invalid dashboard name', function(done) {
  ...
  xit('should have a updateCurrentDashboardName method', function(done) {
